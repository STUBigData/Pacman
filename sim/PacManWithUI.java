...
public class PacManWithUI extends GUIState
    ...
    public static void main(String[] args)
        {
    	PacMan.initializeArguments(args);
        ...
        display.addKeyListener(new KeyAdapter()
            ...
            public void keyPressed(KeyEvent e)   
            {
                ...
                for(int i = 0; i < pacman.dots.allObjects.size(); i++) {
                	Dot dot = ((Dot)pacman.dots.allObjects.objs[i]);
                	System.out.print("Dot ID:" + dot.name + ",");
                	System.out.print("x:" + dot.x + ",");
                	System.out.print("y:" + dot.y + ",");
                	
                	if(dot instanceof Energizer == true) {
                		energizersRemaining++;
                	}
                	else {
                		dotsRemaining++;
                ...
                for(int i = 0; i < pacman.agents.allObjects.size(); i++) {
                	...
                	System.out.print("Agent ID:" + agent.name + ",");
                ...
                System.out.println("DotsRemaining:" + dotsRemaining);
